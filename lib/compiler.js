        ...
        return new Promise(async (res) => {
            ...
            /* Widgets 🤖 */ {
                ...
                do {
                    i = iterator.next();
                    try {
                        !i.done && (App.html = App.html.replace(i.value[0], (i.value.groups.property.includes(".") ? eval(`App.${i.value.groups.property}`) : App[i.value.groups.property]) || ""));
                    }
                    catch {
                ...
                do {
                    i = iterator.next();
                    try {
                        !i.done && (App.html = App.html.replace(i.value[0], (i.value.groups.property.includes(".") ? eval(`App.${i.value.groups.property}`) : App[i.value.groups.property])?.(i.value.groups.value, App) || ""));
                    }
                    catch { }
                } while (!i.done);
                // Files Widget 🤖
    ...
    renderComponent(html, widgets) {
        ...
        /* Widgets 🤖 */ {
            ...
            do {
                i = iterator.next();
                try {
                    !i.done && (component.html = component.html.replace(i.value[0], i.value.groups.property.includes(".") ? eval(`component.${i.value.groups.property}`) : component[i.value.groups.property] || ""));
                }
                catch { }
            } while (!i.done);
            ...
            do {
                i = iterator.next();
                try {
                    !i.done && (component.html = component.html.replace(i.value[0], (i.value.groups.property.includes(".") ? eval(`component.${i.value.groups.property}`) : component[i.value.groups.property])?.(i.value.groups.value, component) || ""));
                }
                catch { }
            } while (!i.done);
        }
